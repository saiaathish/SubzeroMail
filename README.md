...
- Local evidence: 18 Vitest files and 78/78 tests pass; typecheck, a clean production build, formatting, Chrome/WebKit 14/14 E2E, and 12 consecutive Chrome smoke runs pass. This does not prove live Gmail/provider behavior.
